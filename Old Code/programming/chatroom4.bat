...
echo %name%: has joined the chatroom >>\\SHRIGANESH\Users\Public\chat\program_files\msgbox2
start \\SHRIGANESH\Users\Public\chat\program_files\msgbox2.bat
:chat1
...
>>\\SHRIGANESH\Users\Public\chat\program_files\msgbox2
taskkill /im cmd.exe
exit

:clear
cls
echo _________CHAT ROOM____________ >>\\SHRIGANESH\Users\Public\chat\program_files\msgbox2
goto chat1
...
:2
echo %name% : %text% >>\\SHRIGANESH\Users\Public\chat\program_files\msgbox2 
goto chat1
